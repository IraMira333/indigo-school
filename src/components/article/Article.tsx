...
export const Article = ({
    ...
    return (
        ...
        >
            <article className="pc:w-[50%] pc:mb-0 mb-6">
                <h2 className="font-montserrat mb-6 max-w-[300px] text-4xl font-semibold">
                    {article.title}
                </h2>
                {article.text.map((paragraph, index) => (
                    <p
                        className="pc:mx-0 mx-auto mb-4 max-w-[700px] whitespace-pre-line last:mb-0"
                        key={index}
                    >
                        {paragraph}
                    </p>
            ...
            <div className="pc:w-[40%] pc:max-w-full pc:mx-0 mx-auto max-w-[330px]">
                <Image
                    src="/article.png"
                    alt="article"
                    width={1440}
