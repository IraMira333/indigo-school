...
export const privacyPolicyText: DocumentType = {
    ...
    subtitle: [
        {
            paragraph: [{ type: "text", text: "TODO в особі TODO" }],
        },
    ],
            ...
            content: [
                ...
                },
                {
                    paragraph: [
                        {
                            type: "text",
                            text: "«TODO» (далі – Оператор). Оператор ставить своєю найважливішою метою та умовою здійснення своєї діяльності дотримання прав і свобод людини та громадянина при обробці персональних даних відвідувачів сайту, у тому числі захисту прав на недоторканність приватного життя.",
                        },
                    ],
                },
                {
